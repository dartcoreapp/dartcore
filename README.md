...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/mbWboOMKC7)
...
```sh
npx nx serve dartcore
```

To create a production bundle:

```sh
npx nx build dartcore
```

To see all available targets to run for a project, run:

```sh
npx nx show project dartcore
```
